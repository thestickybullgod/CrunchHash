...
SHA256 of Hashps1_v2.2.exe — 62f7245e3774b1c534078c58e6c1f6b81007afb06c557c74444f86c58eb8efb6

SHA256 of Hashps1_v2.2.ps1 — d7243403acdd14d954b2444e061522f649c69aedf7ab07533a7ba28cd0ca5ad6
...
![hashps1](https://img.shields.io/badge/version-2.2-blue.svg)
...
### Quick Start
1. Download `Hashps1_v2.2.ps1`
2. Right-click → **Run with PowerShell**
   
   *Or from PowerShell:*
   ```powershell
   powershell -ExecutionPolicy Bypass -File "Hashps1_v2.2.ps1"
   ```
   
   *Portable mode (no config/cache files):*
   ```powershell
   powershell -ExecutionPolicy Bypass -File "Hashps1_v2.2.ps1" -Portable
   ```
...
6. Click **Generate Hash**
   - Clicking **Generate Hash** after clicking **Log to file** creates "Hash_GUI_Log.txt" in the directory of Hashps1_v2.2.exe/Hashps1_v2.2.ps1
...
5. Click **Hash All** to process
   - Clicking **Hash All** after clicking **Log to file** creates "Batch_GUI_Log.txt" in the directory of Hashps1_v2.2.exe/Hashps1_v2.2.ps1
