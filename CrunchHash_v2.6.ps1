...
function Export-SFVFile {
    ...
    try {
        $sfvContent = "; Generated by CrunchHash v2.5 on $([DateTime]::Now.ToString('yyyy-MM-dd HH:mm:ss'))`r`n"
...
"@
        ...
        [Windows.UI.Notifications.ToastNotificationManager]::CreateToastNotifier("CrunchHash v2.5").Show($toast)
    } catch {
...
function Initialize-TrayIcon {
    ...
    try {
        ...
        $script:notifyIcon.Text = "CrunchHash v2.5"
...
function Update-RecentFilesList {
    if ($listBoxRecentFiles) {
        ...
        foreach ($file in $script:recentFiles) {
            if (Test-Path $file) {
                [void]$listBoxRecentFiles.Items.Add($file)
                # Calculate width needed for horizontal scrolling
                $textWidth = [System.Windows.Forms.TextRenderer]::MeasureText($file, $listBoxRecentFiles.Font).Width
...
if ($script:PortableMode) {
    $form.Text = "CrunchHash v2.5  [WARNING: Portable Mode - No config/cache will be saved]"
} else {
    $form.Text = "CrunchHash v2.5"
}
...
$labelHeader.Text = "CrunchHash v2.5"
...
if ((Test-Path $logPath) -and ((Get-Item $logPath).Length -gt 0)) { $textBoxLogViewer.Text = Get-Content $logPath -Raw } else { $textBoxLogViewer.Text = "No log entries." }
...
$checkClipboardDetect.Checked = $true
...
if ((Test-Path $batchLogPath) -and ((Get-Item $batchLogPath).Length -gt 0)) { $textBoxBatchLogViewer.Text = Get-Content $batchLogPath -Raw } else { $textBoxBatchLogViewer.Text = "No batch log entries." }
...
$labelVerifyFooter.Location = New-Object System.Drawing.Point(110, 583)
$labelVerifyFooter.Size = New-Object System.Drawing.Size(450, 20)
...
$labelDupInfo.Text = "Select directory to search for duplicate files:"
$labelDupInfo.Location = New-Object System.Drawing.Point(20, 10)
$labelDupInfo.Size = New-Object System.Drawing.Size(300, 20)

$comboDupPath = New-Object System.Windows.Forms.ComboBox
$comboDupPath.Location = New-Object System.Drawing.Point(20, 35)
$comboDupPath.Size = New-Object System.Drawing.Size(460, 20)
$comboDupPath.DropDownStyle = 'DropDown'

$buttonDupBrowse = New-Object System.Windows.Forms.Button
$buttonDupBrowse.Text = "Browse..."
$buttonDupBrowse.Location = New-Object System.Drawing.Point(490, 33)
$buttonDupBrowse.Size = New-Object System.Drawing.Size(70, 25)
$buttonDupBrowse.BackColor = [System.Drawing.Color]::FromArgb(0, 122, 204)
$buttonDupBrowse.ForeColor = [System.Drawing.Color]::White

$checkDupRecursive = New-Object System.Windows.Forms.CheckBox
$checkDupRecursive.Text = "Search subdirectories (Recursive)"
$checkDupRecursive.Location = New-Object System.Drawing.Point(20, 65)
$checkDupRecursive.AutoSize = $true
$checkDupRecursive.Checked = $true

$labelDupAlgo = New-Object System.Windows.Forms.Label
$labelDupAlgo.Text = "Hash Algorithm:"
$labelDupAlgo.Location = New-Object System.Drawing.Point(300, 67)
$labelDupAlgo.Size = New-Object System.Drawing.Size(100, 20)

$comboDupAlgo = New-Object System.Windows.Forms.ComboBox
$comboDupAlgo.Location = New-Object System.Drawing.Point(410, 65)
$comboDupAlgo.Size = New-Object System.Drawing.Size(150, 20)
...
$labelDupExtensions.Text = "Filter by Extensions:"
$labelDupExtensions.Location = New-Object System.Drawing.Point(20, 97)
$labelDupExtensions.AutoSize = $true

$textBoxDupExtensions = New-Object System.Windows.Forms.TextBox
$textBoxDupExtensions.Location = New-Object System.Drawing.Point(145, 95)
$textBoxDupExtensions.Size = New-Object System.Drawing.Size(365, 20)
...
$buttonDupFind.Text = "Find Duplicates"
$buttonDupFind.Location = New-Object System.Drawing.Point(520, 90)
$buttonDupFind.Size = New-Object System.Drawing.Size(40, 30)
...
$labelDupResults.Location = New-Object System.Drawing.Point(20, 128)
$labelDupResults.Size = New-Object System.Drawing.Size(200, 20)

$textBoxDupResults = New-Object System.Windows.Forms.RichTextBox
$textBoxDupResults.Location = New-Object System.Drawing.Point(20, 153)
$textBoxDupResults.Size = New-Object System.Drawing.Size(540, 360)
...
$buttonDupCopy = New-Object System.Windows.Forms.Button
$buttonDupCopy.Text = "Copy Results"
$buttonDupCopy.Location = New-Object System.Drawing.Point(20, 560)
$buttonDupCopy.Size = New-Object System.Drawing.Size(100, 30)
$buttonDupCopy.BackColor = [System.Drawing.Color]::FromArgb(0, 122, 204)
$buttonDupCopy.ForeColor = [System.Drawing.Color]::White

$buttonDupExport = New-Object System.Windows.Forms.Button
$buttonDupExport.Text = "Export Results"
$buttonDupExport.Location = New-Object System.Drawing.Point(130, 560)
...
$buttonDupClear.Location = New-Object System.Drawing.Point(250, 560)
...
# Add MouseClick handler for clickable file paths
$script:dupFileLinks = @()
$textBoxDupResults.Add_MouseClick({
    param($s, $e)
    try {
        # Get the character index at the mouse position
        $charIndex = $textBoxDupResults.GetCharIndexFromPosition($e.Location)

        # Check if click is on a file path link
        foreach ($linkInfo in $script:dupFileLinks) {
            if ($charIndex -ge $linkInfo.Start -and $charIndex -lt ($linkInfo.Start + $linkInfo.Length)) {
                if (Test-Path $linkInfo.Path) {
                    Start-Process explorer.exe -ArgumentList "/select,`"$($linkInfo.Path)`""
                }
                break
            }
        }
...
$textBoxDupResults.Add_MouseMove({
    ...
    try {
        ...
        if ($overLink) {
            $textBoxDupResults.Cursor = [System.Windows.Forms.Cursors]::Hand
        } else {
            $textBoxDupResults.Cursor = [System.Windows.Forms.Cursors]::IBeam
        }
    } catch {
        # Silently ignore errors
    }
...
$tabDuplicateFinder.Controls.Add($comboDupPath)
$tabDuplicateFinder.Controls.Add($buttonDupBrowse)
...
$tabDuplicateFinder.Controls.Add($buttonDupCopy)
...
$buttonVerifyStop.Add_Click({
    ...
    $buttonVerifyStop.Enabled = $false
    $labelVerifyFooter.Text = "Stopping verification..."
})
...
$buttonVerify.Add_Click({
    ...
    $currentLine = 0
    $startTime = [DateTime]::Now
    $resultBuffer = New-Object System.Text.StringBuilder

    try {
        foreach ($line in $lines) {
        # Check if user requested stop
        if ($script:verifyShouldStop) {
            [void]$resultBuffer.AppendLine("`r`n========== VERIFICATION STOPPED BY USER ==========")
            break
        }
        ...
        # Update progress bar every file for smooth animation
        $script:verifyTargetWidth = [int](($percent / 100.0) * $panelVerifyProgressBackground.Width)
        $panelVerifyProgressFill.Width = $script:verifyTargetWidth

        # Update UI labels and process events every 10 files to prevent lag
        if (($currentLine % 10) -eq 0 -or $currentLine -eq $totalLines) {
            $elapsed = ([DateTime]::Now - $startTime).TotalSeconds
            $labelVerifyFooter.Text = "Processing file $currentLine of $totalLines ($percent%) - $([int]$elapsed)s elapsed"
            [System.Windows.Forms.Application]::DoEvents()

            # Check after DoEvents in case user clicked Stop or Close
            if ($script:verifyShouldStop) {
                [void]$resultBuffer.AppendLine("`r`n========== VERIFICATION STOPPED BY USER ==========")
                break
            }
        ...
        if ($line -match '^([a-fA-F0-9]+|0x[a-fA-F0-9]+|[A-Za-z0-9+/]+=*)\s+(.*)$') {
            ...
            if (-not (Test-Path $fullPath)) {
                $resultLine = "MISSING: $filename"
                $missingCount++
            } else {
                try {
                    # Compute hash using streaming to handle large files
                    if ($algoName -eq "CRC32") {
                        $fs = [System.IO.File]::OpenRead($fullPath)
                        try {
                            # Create a progress callback for large files to keep UI responsive
                            $progressCallback = {
                                param($percent, $speed)
                                if (($percent % 10) -eq 0) {
                                    $labelVerifyFooter.Text = "Processing file $currentLine of $totalLines - Hashing: $percent%"
                                    [System.Windows.Forms.Application]::DoEvents()
                                    # Check if user requested stop during hashing
                                    if ($script:verifyShouldStop) {
                                        throw "Verification stopped by user"
                                    }
                                }
                            }
                            $crc32 = [FastCRC32]::ComputeHashStream($fs, $progressCallback)
                        ...
                        $fs = [System.IO.File]::OpenRead($fullPath)
                        try {
                            # Use streaming hash computation for large files (prevents memory issues)
                            ...
                            while (($bytesRead = $fs.Read($buffer, 0, $bufferSize)) -gt 0) {
                                ...
                                # For large files, update UI every 512 chunks (~32MB) to prevent freezing
                                if (($chunkCount % 512) -eq 0) {
                                    $filePercent = if ($fileSize -gt 0) { [int](($totalRead * 100) / $fileSize) } else { 0 }
                                    $labelVerifyFooter.Text = "Processing file $currentLine of $totalLines - Hashing: $filePercent%"
                                    [System.Windows.Forms.Application]::DoEvents()
                                    # Check if user requested stop during hashing
                                    if ($script:verifyShouldStop) {
                                        break
                    ...
                    if ($selectedVerifyFormat -eq "base64") {
                        # Compare as base64: decode expected, compare bytes
                        try {
                            ...
                            if ($isMatch) {
                                $resultLine = "MATCH: $filename"
                                $matchCount++
                            } else {
                                $resultLine = "MISMATCH: $filename (expected: $expectedHash, got: " + [Convert]::ToBase64String($hashBytes) + ")"
                                $mismatchCount++
                            }
                        } catch {
                            $resultLine = "ERROR: $filename - Invalid base64 expected hash or comparison failed."
                            $mismatchCount++
                        }
                    } else {
                        # Format computed hash according to selected format
                        $formattedComputedHash = Format-HashOutput $computedHash $selectedVerifyFormat
                        # Normalize expected hash for comparison (format input as well)
                        $formattedExpectedHash = Format-HashOutput ($expectedHash -replace '^0x', '') $selectedVerifyFormat
                        if ($formattedComputedHash -eq $formattedExpectedHash) {
                            $resultLine = "MATCH: $filename"
                            $matchCount++
                        } else {
                            $resultLine = "MISMATCH: $filename (expected: $formattedExpectedHash, got: $formattedComputedHash)"
                            $mismatchCount++
                        }
                    }
                } catch {
                    $resultLine = "ERROR: $filename - $($_.Exception.Message)"
                    $mismatchCount++
                }
            }
        } else {
            $resultLine = "INVALID LINE: $line"
        }
        
        # Append result to buffer and update display immediately after every file
        if (-not [string]::IsNullOrWhiteSpace($resultLine)) {
            [void]$resultBuffer.AppendLine($resultLine)

            # Update display after every single file for real-time feedback
            try {
                $textBoxVerifyResults.Text = "Verifying files...`r`n`r`n" + $resultBuffer.ToString()
                $textBoxVerifyResults.SelectionStart = $textBoxVerifyResults.Text.Length
                $textBoxVerifyResults.ScrollToCaret()
            } catch {
                # If UI update fails, continue processing but log the issue
                Write-Host "UI update failed at file $currentLine : $($_.Exception.Message)"
            }
        }
    }
    } catch {
        $errorMsg = "Verification error at line $currentLine : $($_.Exception.Message)`r`nStack: $($_.ScriptStackTrace)"
        try {
            $textBoxVerifyResults.Text = $resultBuffer.ToString() + "`r`n`r`nERROR: $errorMsg`r`n"
        } catch {
            # If textbox update fails entirely, just show messagebox
        }
        $labelVerifyFooter.Text = "Error occurred during verification"

        # Re-enable buttons on error
        $buttonVerify.Enabled = $true
        $buttonVerifyStop.Enabled = $false

        [System.Windows.Forms.MessageBox]::Show($errorMsg, "Verification Error", [System.Windows.Forms.MessageBoxButtons]::OK, [System.Windows.Forms.MessageBoxIcon]::Error)
        return
    }

    $summary = "`r`n`r`n========== VERIFICATION SUMMARY ==========`r`n"
    $summary += "Total: $totalLines | Match: $matchCount | Mismatch: $mismatchCount | Missing: $missingCount`r`n"
    $summary += "==========================================`r`n"

    # Final update with summary
    $textBoxVerifyResults.Text = $resultBuffer.ToString() + $summary
    $textBoxVerifyResults.SelectionStart = $textBoxVerifyResults.Text.Length
    $textBoxVerifyResults.ScrollToCaret()
    ...
    if ($script:verifyShouldStop) {
        $labelVerifyFooter.Text = "Stopped - $currentLine of $totalLines files processed in $([int]$totalElapsed)s"
    } else {
...
$buttonDupBrowse.Add_Click({
    $folderBrowser = New-Object System.Windows.Forms.FolderBrowserDialog
    $folderBrowser.Description = "Select directory to search for duplicates"
    $folderBrowser.ShowNewFolderButton = $false

    if ($comboDupPath.Text) {
        $folderBrowser.SelectedPath = $comboDupPath.Text
    }

    $dialogResult = $folderBrowser.ShowDialog()
    if ($dialogResult -eq [System.Windows.Forms.DialogResult]::OK) {
        $comboDupPath.Text = $folderBrowser.SelectedPath

        # Add to recent paths if not already there
        $containsPath = $comboDupPath.Items -notcontains $folderBrowser.SelectedPath
        if ($containsPath) {
            [void]$comboDupPath.Items.Insert(0, $folderBrowser.SelectedPath)
            # Keep only last 10 paths
            $itemCount = $comboDupPath.Items.Count
            while ($itemCount -gt 10) {
                [void]$comboDupPath.Items.RemoveAt($itemCount - 1)
                $itemCount = $comboDupPath.Items.Count
            }
        }
    }
...
$buttonDupClear.Add_Click({
    ...
    $tempFiles = @($script:dupTempFile, $script:dupProgressFile, "$($script:dupProgressFile).stop")
...
$buttonDupCopy.Add_Click({
    if ($textBoxDupResults.Text) {
        [System.Windows.Forms.Clipboard]::SetText($textBoxDupResults.Text)
        $labelDupFooter.Text = "Results copied to clipboard"
    }
})
...
$buttonDupFind.Add_Click({
    if (-not $comboDupPath.Text) {
        [System.Windows.Forms.MessageBox]::Show("Please select a directory first.", "No Directory Selected", [System.Windows.Forms.MessageBoxButtons]::OK, [System.Windows.Forms.MessageBoxIcon]::Warning)
        return
    }

    if (-not (Test-Path $comboDupPath.Text)) {
        [System.Windows.Forms.MessageBox]::Show("The selected directory does not exist.", "Invalid Directory", [System.Windows.Forms.MessageBoxButtons]::OK, [System.Windows.Forms.MessageBoxIcon]::Error)
        return
    }
    ...
    $buttonDupBrowse.Enabled = $false
    $textBoxDupResults.Text = ""
    $labelDupFooter.Text = "Scanning directory..."
    $labelDupProgressPercent.Text = "0%"
    $panelDupProgressFill.Width = 0

    $searchPath = $comboDupPath.Text
    ...
    [void]$script:dupRunspace.AddScript({
        param($path, $isRecursive, $algo, $tempFile, $progressFile, $extensionFilter, $stopFile)

        try {
            # Get all files
            $allFiles = if ($isRecursive) {
            ...
            if ($extensionFilter) {
                ...
                $files = $allFiles | Where-Object {
                    ...
                    $extArray | Where-Object { $ext -like "*$_" } | Select-Object -First 1
                }
            } else {
                $files = $allFiles
            }

            # Group by size first (optimization - files must be same size to be duplicates)
            ...
            # Write initial progress so UI knows job started
            "0|$totalFiles|SCANNING" | Out-File -FilePath $progressFile -Force -Encoding UTF8

            $hashTable = @{}
            $sizeTable = @{}  # Track file sizes for wasted space calculation
            $processed = 0
            $stopped = $false
            ...
            foreach ($file in $filesToHash) {
                try {
                    ...
                    if ($hashTable[$hash].Count -eq 2) {
                        # This is a new duplicate - write it incrementally
                        $duplicateSetNumber++
                        $dupEntry = @{
                            Hash = $hash
                        ...
                        # Find the set number for this hash
                        $setNum = 0
                    ...
                    # Update progress (processed|total|status)
                    "$processed|$totalFiles|SCANNING" | Out-File -FilePath $progressFile -Force -Encoding UTF8
    ...
    [void]$script:dupRunspace.AddArgument($searchPath)
...
$buttonBatchClear.Add_Click({
    ...
    Start-Sleep -Milliseconds 300
    $tempFiles = @($script:batchProgressFile, $script:batchFileProgressFile, $script:batchCacheFile, $script:batchTempFile, $hashSpeedFile)
    foreach ($file in $tempFiles) {
        if ($file -and (Test-Path $file)) {
            $retries = 3
            $deleted = $false
...
$buttonExportVerifyLog.Add_Click({
    ...
    if ($saveDialog.ShowDialog() -eq "OK") {
        try {
            ...
            foreach ($line in $lines) {
                # Try to match all possible result formats (hex, base64, 0x, tab/space, [CACHED])
                $m1 = [regex]::Match($line, '^((?:0x)?[a-fA-F0-9]{8,}|[A-Za-z0-9+/=]{16,})\tSize: .+?\tModified: .+?\t(.+?)(?:\t\[CACHED\])?$')
                if ($m1.Success) {
                    $hash = $m1.Groups[1].Value.Trim()
                    $filePath = $m1.Groups[2].Value.Trim() -replace '\s*\[CACHED\]\s*$', ''
                    $verifyLogLines += "$filePath`: $hash"
                    continue
                }
                # Also support: hash<tab>filename (for simple batch results)
                $m2 = [regex]::Match($line, '^((?:0x)?[a-fA-F0-9]{8,}|[A-Za-z0-9+/=]{16,})\t(.+?)$')
                if ($m2.Success) {
                    $hash = $m2.Groups[1].Value.Trim()
                    $filePath = $m2.Groups[2].Value.Trim() -replace '\s*\[CACHED\]\s*$', ''
                    $verifyLogLines += "$filePath`: $hash"
                    continue
                }
                # Also support: hash space filename
                $m3 = [regex]::Match($line, '^((?:0x)?[a-fA-F0-9]{8,}|[A-Za-z0-9+/=]{16,})\s+(.+?)$')
                if ($m3.Success) {
                    $hash = $m3.Groups[1].Value.Trim()
                    $filePath = $m3.Groups[2].Value.Trim() -replace '\s*\[CACHED\]\s*$', ''
                    $verifyLogLines += "$filePath`: $hash"
                    continue
                }
            }
...
$buttonBatchHash.Add_Click({
    ...
    # Check for network paths and verify accessibility with timeout
    $networkFiles = @()
    ...
    try {
        ...
        $job = Start-Job -ScriptBlock {
            param($files, $algoName, $keyBytes, $format, $tempFile, $progressFile, $fileProgressFile, $speedFile, $threadCount, $cacheArray, $cacheFile)
...
"@
                ...
                try {
                    if (Test-Path $file -ErrorAction SilentlyContinue) {
                        ...
                        try {
                            ...
                            if ($algoName -eq "CRC32") {
                                # CRC32 with progress and speed tracking
                                $crc = 0xFFFFFFFF
                                ...
                                while (($bytesRead = $fs.Read($buffer, 0, $bufferSize)) -gt 0) {
                                    for ($i = 0; $i -lt $bytesRead; $i++) {
                                        $index = ($crc -bxor $buffer[$i]) -band 0xFF
                                        $crc = ($crc -shr 8) -bxor $crcTable[$index]
                                    }
        ...
        } -ArgumentList $filesToHash, $algoName, $keyBytes, $selectedFormat, $script:batchTempFile, $script:batchProgressFile, $script:batchFileProgressFile, $hashSpeedFile, $script:parallelThreadCount, $cacheArray, $script:batchCacheFile
            ...
            if (Test-Path $script:batchFileProgressFile) {
                try {
                    ...
                    if ($fileParts.Count -eq 2) {
                        ...
                        $currentFileIndex = [int]$fileParts[1]
                        ...
                        } elseif ($targetFileWidth -lt $currentFileWidth -and $targetFileWidth -lt $panelBatchFileProgressBackground.Width) {
                            # Only decrease if not at or near end
            ...
            if (Test-Path $script:dupTempFile) {
                try {
                    ...
                    if ($hasUpdates -and $script:dupSets.Count -gt 0) {
                        ...
                        $summary = "SUMMARY: $dupCount duplicate set(s) found | $totalDups total files | Wasted space: $wastedStr`n"
                        $summary += "(Click any file path to open its location in Explorer)`n`n"
                        ...
                        # Now find and link all file paths during incremental updates
                        $filePathsToLink = @()

                        # Determine link color based on theme
                        $linkColor = if ($checkDarkMode.Checked) {
                            [System.Drawing.Color]::FromArgb(100, 180, 255)  # Bright cyan-blue for dark mode
                        } else {
                            [System.Drawing.Color]::FromArgb(0, 100, 200)  # Dark blue for light mode
                        }

                        # Split text into lines and process each one
                        $currentPos = 0
                        $textLines = $textBoxDupResults.Text -split "`n"

                        foreach ($line in $textLines) {
                            # Check if line starts with "  - " (file path line)
                            if ($line -match '^  - (.+)$') {
                                # File path starts at position: currentPos + 4 (skip "  - ")
                                $pathStart = $currentPos + 4
                                $filePath = $matches[1]
                                $pathLength = $filePath.Length

                                # Apply formatting
                                $textBoxDupResults.Select($pathStart, $pathLength)
                                $textBoxDupResults.SelectionColor = $linkColor
                                $textBoxDupResults.SelectionFont = New-Object System.Drawing.Font($textBoxDupResults.Font, [System.Drawing.FontStyle]::Underline)

                                # Store for click handler
                                $filePathsToLink += @{Start = $pathStart; Length = $pathLength; Path = $filePath}
                            }

                            # Move position forward (line length + 1 for newline)
                            $currentPos += $line.Length + 1
                        }

                        # Store links in script variable for click handler
                        $script:dupFileLinks = $filePathsToLink
                ...
                try {
                    ...
                    if ($parts.Count -ge 3) {
                        ...
                        if ($total -gt 0) {
                            ...
                            $labelDupFooter.Text = "Scanning... $processed of $total files ($percent%) - Found $($script:dupSets.Count) duplicate sets"
                        }
                        ...
                        if ($status -eq "COMPLETE" -or $status -eq "STOPPED") {
                            if ($isRunspaceCompleted -or -not $script:dupHandle) {
                                ...
                                if ($finalDupCount -eq 0) {
                                    ...
                                    # NOW apply link formatting to all file paths
                                    $filePathsToLink = @()
                                    $lines = $textBoxDupResults.Lines
                                    $currentPos = 0
                                    ...
                                    # Reset selection
                                    $textBoxDupResults.SelectionStart = 0
                                    $textBoxDupResults.SelectionLength = 0
                    ...
                    $labelDupFooter.Text = "Error reading progress: $($_.Exception.Message)"
                }
            } else {
                # Progress file doesn't exist yet
                if ($script:dupHandle -and -not $isRunspaceCompleted) {
                    $labelDupFooter.Text = "Job running... waiting for progress file"
                }
            }
        }
    } catch { }
...
$buttonCompare.Add_Click({
    ...
    if ($script:generatedHash -eq $compareHash) {
        ...
        $textBoxResult.ForeColor = [System.Drawing.Color]::Black
        $textBoxResult.Text = (($script:generatedHash -replace "`r?`n", "") + " | MATCH") -replace "`r?`n", ""
        $textBoxResult.TextAlign = "Left"
        ...
        $textBoxResult.ForeColor = [System.Drawing.Color]::Black
        $textBoxResult.Text = (($script:generatedHash -replace "`r?`n", "") + " | MISMATCH") -replace "`r?`n", ""
...
$form.Add_Resize({
    if ($form.WindowState -eq 'Minimized' -and $checkMinimizeToTray.Checked) {
        ...
        if ($script:currentJobId -or $script:batchJobId) {
            $script:notifyIcon.BalloonTipTitle = "CrunchHash v2.5"
...
$tooltip.SetToolTip($buttonDupBrowse, "Browse for a directory to search for duplicate files")
...
$tooltip.SetToolTip($buttonDupFind, "Start searching for duplicate files in the selected directory")
$tooltip.SetToolTip($buttonDupStop, "Stop the current duplicate search")
$tooltip.SetToolTip($textBoxDupResults, "Duplicate files found will be listed here, grouped by hash. Click any file path to open its location in Explorer.")
$tooltip.SetToolTip($buttonDupCopy, "Copy the duplicate file results to clipboard")
